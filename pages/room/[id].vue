...
import { PokerRoomKey, usePokerRoom } from '~/composables/usePokerRoom';
      ...
      <div class="mx-auto max-w-screen-xl px-4 py-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-4">
            ...
            <VotingScaleSelector
              v-if="isJoined"
              :current-scale-id="roomState.votingScale"
    ...
    <main class="flex-grow p-4 sm:p-6 lg:p-8">
      ...
      >
        <div class="text-center py-12">
          ...
          <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-2 transition-colors duration-200">
            Connection Failed
          </h2>
